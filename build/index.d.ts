 ...
 */
export declare type NumericWriter = (quantity: number) => string;
/**
 ...
 * [[to]].
 */
export declare class Time implements NanosecondBasedTime {
    /**
     ...
     */
    static from(value: number, timeUnit: TimeUnitParameter): Time;
    private _value;
     ...
     */
    constructor(value: number | NanosecondBasedTime);
    /**
     ...
     *   A new [[Time]] object with the resulting time.
     */
    multiply(time2: number | Time): Time;
    /**
     ...
     *   A new [[Time]] object with the resulting time.
     */
    subtract(time2: number | Time): Time;
    /**
     ...
     */
    to(timeUnit: TimeUnitParameter): number;
    /**
...
export declare class TimeWriter {
    private _settings;
    private _timeUnitSettingsCache;
    private _writerSettingsCache;
    /** Gets or sets the object containing the [[TimeWriterSettings]] of this time writer. */
    readonly settings: TimeWriterSettings;
    /**
     ...
     */
    write(timeValue: number, originTimeUnit?: TimeUnitParameter, targetTimeUnit?: TimeUnitParameter, options?: TimeWriterSettings): string;
    /**
     * Synthesizes a string representing the given `timeValue`.
     *
     ...
     *   An optional set of configurations overwriting the values from both this object and the [[Locale]].
     */
    write(timeValue: number, timeUnit?: TimeUnitParameter, options?: TimeWriterSettings): string;
    /**
     * Synthesizes a string representing the given `timeValue`.
     *
     ...
     *   An optional set of configurations overwriting the values from both this object and the [[Locale]].
     */
    write(timeValue: number, options?: TimeWriterSettings): string;
    /**
     ...
     *   An optional set of configurations overwriting the values from both this object and the [[Locale]].
     */
    write(time: NanosecondBasedTime, targetTimeUnit?: TimeUnitParameter, options?: TimeWriterSettings): string;
    /**
     * Synthesizes a string representing the given `time`.
     *
     ...
     *   An optional set of configurations overwriting the values from both this object and the [[Locale]].
     */
    write(time: NanosecondBasedTime, options?: TimeWriterSettings): string;
    private _createTimeUnitSettingsCache;
    private _createWriterSettingsCache;
    private _writeNumber;
    private _writeRoman;
    private _writeRomanFraction;
